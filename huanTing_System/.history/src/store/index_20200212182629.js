...
const store = new Vuex.Store({
  ...
  mutations: {
    ...
    previewImg(state, data) {
      state.imgPreviewConfig.imageKeys = data.imageKeys
      state.imgPreviewConfig.currentIndex = data.currentIndex
      state.imgPreviewConfig.imageContent = data.imageContent
      state.previewPicFlag = true
    },
    // 关闭全局预览
    closeImgPreview(state, flag) {
      state.previewPicFlag = flag
    }
  }
})

    ...
    <el-dialog
      ...
      <el-form style="padding-right: 50px;" ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="网站logo" prop="webLogo">
          <el-input v-model="form.webLogo"></el-input><br>
          <img :src="form.webLogo" alt="" class="table_img" :onerror="defaultImg">
        </el-form-item>
        ...
        <el-form-item label="作者微信" prop="weChat">
          <el-input v-model="form.weChat"></el-input><br>
          <img :src="form.weChat" alt="" class="table_img" :onerror="defaultImg">
        </el-form-item>
  ...
  methods: {
    ...
    handleImgSuccess(res) {
      if (res.success) {
        ...
        this.singerForm.webLogo = res.data.url
      }
    },
    // 更新网站信息
    saveForm() {

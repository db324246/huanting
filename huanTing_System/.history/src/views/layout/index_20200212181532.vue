  ...
  <div class="right_container">
    ...
    <transition name="el-zoom-in-bottom">
      <div v-show="$store.state.audioDialog" class="transition-box">
        <img class="audioImage" :src="$store.state.audioAlbum" alt="" :onerror="defaultImg">
        <div class="audioBox">
...
import imagePreview from '@/componenets/myPreview.vue';
export default {
  components: {
    imagePreview
  },
  ...
  methods: {
    ...
    // 监听图片预览组件的传值 关闭图片预览
    closePreview(flag) {
      this.$store.commit('closePreview', flag)

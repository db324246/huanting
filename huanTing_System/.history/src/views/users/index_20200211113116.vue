<template>
  ...
  <div v-else-if="$route.path === '/userManage'" >
    <div class="nav_top">
        <el-button-group>
          <el-button size="mini" :type="userFlag ? 'info' : 'primary'" @click="userflag = false">管理员</el-button>
          <el-button size="mini" :type="userFlag ? 'primary' : 'info'" @click="userflag = true">用户管理</el-button>
        </el-button-group>
    </div>
        ...
        <el-table-column type="expand" width="1">
          <template slot-scope="scope">
            <div class="expandBox">
              ...
              <el-button v-if="scope.row.identity_id === '2'" @click="showBindRootDialog(scope.row)" size="small">添加权限</el-button>
            </div>
          </template>
        </el-table-column>
        <el-table-column

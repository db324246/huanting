<template>
  ...
  <div v-else-if="$route.path === '/userManage'" >
    <div class="nav_top">
        <el-button-group>
          <el-button size="mini" :type="userFlag ? '' : 'primary'" @click="userFlag = false">管理员</el-button>
          <el-button size="mini" :type="userFlag ? 'primary' : ''" @click="userFlag = true">用户管理</el-button>
        </el-button-group>
    </div>
